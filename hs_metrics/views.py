...
class MyHPOMSiteMetrics(TemplateView):
    template_name = 'hs_metrics/hydrosharesitemetrics.html'

    @method_decorator(login_required)
    def dispatch(self, request, *args, **kwargs):
        return super(MyHPOMSiteMetrics, self).dispatch(request, *args, **kwargs)

    def __init__(self, **kwargs):
        super(MyHPOMSiteMetrics, self).__init__(**kwargs)
    ...
    def get_context_data(self, **kwargs):
        ...
        6.	The quantity of hydrological data including data values, sites, and variables, and web service data requests
            per day.
        7.	The number of non-CUAHSI agencies that utilize MyHPOM (e.g. NCDC).
        ...
        9.	The number of contributors to non-core code that is part of the system, such as clients or apps and other
            software projects where changes are made to adapt for MyHPOM
        ...
        13.	Number of citations of various MyHPOM resources.
        ...
        ctx = super(MyHPOMSiteMetrics, self).get_context_data(**kwargs)
