    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('run_id', models.CharField(default=True, help_text=b'The id of this production run at CloudFactory.', max_length=64, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input', models.TextField(help_text=b'A json-string containing the input to CloudFactory; use to validate the response.')),
                ('output', models.TextField(help_text=b'A json-string containing the output from CloudFactory')),
