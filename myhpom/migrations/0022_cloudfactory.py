    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input', models.TextField(help_text=b'JSON input to CloudFactory; use to validate the response.', blank=True)),
                ('output', models.TextField(help_text=b'JSON output from CloudFactory', blank=True)),
