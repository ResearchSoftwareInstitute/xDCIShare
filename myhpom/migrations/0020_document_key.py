    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiration', models.DateTimeField(help_text=b'The optional timestamp indicating when this DocumentKey expires.', null=True)),
                ('ip', models.CharField(help_text=b'The optional IP address or range to which this DocumentKey is limited', max_length=64, null=True)),
