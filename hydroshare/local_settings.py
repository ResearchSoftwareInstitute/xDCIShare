...
CLOUDFACTORY_LINE_ID=os.environ.get('CLOUDFACTORY_LINE_ID')
CLOUDFACTORY_AUTH_USERNAME=os.environ.get('CLOUDFACTORY_AUTH_USERNAME')
CLOUDFACTORY_AUTH_PASSWORD=os.environ.get('CLOUDFACTORY_AUTH_PASSWORD')
CLOUDFACTORY_API_URL = 'https://%s:%s@api.cloudfactory.com/v4' % (
    CLOUDFACTORY_AUTH_USERNAME,
    CLOUDFACTORY_AUTH_PASSWORD,
)
CLOUDFACTORY_CALLBACK_AUTH = os.environ.get('CLOUDFACTORY_CALLBACK_AUTH', '')
CLOUDFACTORY_CALLBACK_ENFORCE_AUTH = os.environ.get('CLOUDFACTORY_CALLBACK_ENFORCE_AUTH', False)
