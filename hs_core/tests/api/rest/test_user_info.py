...
class TestUserInfo(APITestCase):
    ...
    def test_user_info(self):
        ...
        self.assertEqual(content['username'][1], self.username)
        self.assertEqual(content['email'][1], self.email)
        self.assertEqual(content['first_name'][1], self.first_name)
        self.assertEqual(content['last_name'][1], self.last_name)
